...
The codebase selects a mixer per block from the configured \texttt{layer\_pattern}. The dispatch logic enforces the training-free policy for eval-only blocks and routes to the corresponding family implementation.
