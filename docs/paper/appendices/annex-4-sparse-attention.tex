...
MSA & $O(H_{\text{kv}}d_{\text{idx}}N^2 + H_q d_h N k B_k)$ & Y & Block top-$k$ & 2026 & Index-branch block sparse (deployed 109B) \\
SparDA & $O(H_{\text{kv}}d_f N N_b + H_q d_h N k B_k)$ & Y & Forecast block & 2026 & Lookahead prefetch decoupled selection \\
\bottomrule
\end{longtable}
\normalsize
