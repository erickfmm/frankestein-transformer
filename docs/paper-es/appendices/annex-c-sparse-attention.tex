...
MSA & $O(H_{\text{kv}}d_{\text{idx}}N^2 + H_q d_h N k B_k)$ & Sí & Bloques top-$k$ & 2026 & Bloques dispersos con rama índice (desplegado 109B) \\
SparDA & $O(H_{\text{kv}}d_f N N_b + H_q d_h N k B_k)$ & Sí & Pronóstico de bloques & 2026 & Selección desacoplada con prefetch anticipado \\
\bottomrule
\end{longtable}
\normalsize
