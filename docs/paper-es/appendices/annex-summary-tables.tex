...
Este anexo proporciona una referencia completa de todos los componentes implementados en el código base de Frankestein Transformer: 35 mezcladores de secuencia en seis familias, 23 optimizadores, 5 variantes de normalización y 4 métodos de embedding. Cada tabla es autocontenida y referencia la bibliografía.
